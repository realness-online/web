...
export const default_keymap = [
  {
    ...
    descriptions: {
      ...
      'pref::Toggle_Show_Menu': 'Toggle menu indicator on posters',
      ...
      'pref::Toggle_Boulders': 'Toggle boulders visibility',
      'pref::Toggle_Rocks': 'Toggle rocks visibility',
