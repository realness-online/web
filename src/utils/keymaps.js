...
export const default_keymap = [
  {
    ...
    descriptions: {
      ...
      'pref::Toggle_Fill': 'Toggle fill gradient on posters (Shift+F)',
      'pref::Toggle_Stroke': 'Toggle stroke outline on posters (Shift+S)',
      'pref::Toggle_Cutout': 'Toggle cutout display on posters (Shift+C)',
      'pref::Toggle_Background': 'Toggle background fill on posters (Shift+B)',
      'pref::Toggle_Light': 'Toggle lightbar on posters (Shift+L)',
      'pref::Toggle_Animate': 'Toggle poster animation (Shift+A)',
      'pref::Toggle_FPS': 'Toggle FPS display (Shift+D)',
      'nav::Go_Home': 'To home',
