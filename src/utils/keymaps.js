...
export const default_keymap = [
  {
    ...
    descriptions: {
      'ui::Toggle_Fullscreen': 'Toggle fullscreen mode (Ctrl+F)',
      'ui::Open_Settings': 'Open application settings (Ctrl+.)',
      'ui::Show_Documentation':
        'Show application documentation (Ctrl+? or Ctrl+/)',
      'pref::Toggle_Fill': 'Toggle fill gradient on posters (F)',
      'pref::Toggle_Stroke': 'Toggle stroke outline on posters (S)',
      'pref::Toggle_Cutout': 'Toggle cutout display on posters (C)',
      'pref::Toggle_Background': 'Toggle background fill on posters (B)',
