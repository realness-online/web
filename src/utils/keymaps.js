...
export const default_keymap = [
  {
    ...
    bindings: {
      ...
      'ctrl-/': 'ui::Show_Documentation',
      'ctrl-f': 'pref::Toggle_Fill',
      'ctrl-s': 'pref::Toggle_Stroke',
      'ctrl-c': 'pref::Toggle_Cutout',
      'ctrl-b': 'pref::Toggle_Background',
      'ctrl-l': 'pref::Toggle_Light',
      'ctrl-a': 'pref::Toggle_Animate',
      'ctrl-d': 'pref::Toggle_FPS',
      0: 'nav::Go_Home',
      1: 'nav::Go_Thoughts',
      2: 'nav::Go_Posters',
      3: 'nav::Go_Events',
    ...
    descriptions: {
      ...
      'pref::Toggle_Fill': 'Toggle fill gradient on posters (Ctrl+F)',
      'pref::Toggle_Stroke': 'Toggle stroke outline on posters (Ctrl+S)',
      'pref::Toggle_Cutout': 'Toggle cutout display on posters (Ctrl+C)',
      'pref::Toggle_Background': 'Toggle background fill on posters (Ctrl+B)',
      'pref::Toggle_Light': 'Toggle lightbar on posters (Ctrl+L)',
      'pref::Toggle_Animate': 'Toggle poster animation (Ctrl+A)',
      'pref::Toggle_FPS': 'Toggle FPS display (Ctrl+D)',
      'nav::Go_Home': 'To home',
