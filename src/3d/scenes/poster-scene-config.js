...
export const INITIAL_ATMOSPHERE_ENABLED = true
export const INITIAL_ATMOSPHERE_COLOR = DEFAULT_ATMOSPHERE_COLOR
export const INITIAL_ATMOSPHERE_DENSITY = DEFAULT_ATMOSPHERE_DENSITY
