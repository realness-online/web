...
See the root `LICENSE` for the full GPL-2.0 text, `/license` in the app for the
user-facing notices, and the in-app documentation (`src/content/documentation.md`,
"How posters are made") for credit.
