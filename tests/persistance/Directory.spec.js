...
describe('Directory validation', () => {
  describe('is_directory_id', () => {
    it('validates correct directory ids', () => {
      expect(is_directory_id('/+16282281824/posters/index/')).toBe(true)
      expect(is_directory_id('/+16282281824/statements/index/')).toBe(true)
      expect(is_directory_id('/+16282281824/events/index/')).toBe(true)
