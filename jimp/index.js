...
import ImagePHash from '@/jimp/modules/phash'
import { isNodePattern, throwError, scan, scanIterator } from '@jimp/utils'
import promisify from '@/jimp/utils/promisify'
import * as MIME from '@/jimp/utils/mime'
import {
  parseBitmap,
  getBuffer,
  getBufferAsync
} from '@/jimp/utils/image-bitmap'

import resize from '@/jimp/modules/resize'
